...
uv.Graph.prototype.init = function () {
  ...
  if(self.config.legend.showlegends){
    self.setLegend(self.config.legend.legendHandler ? self.config.legend.legendHandler : uv.effects.legend.click);
  }
...
* @return {Object}  The graph object itself, to support method chaining
*/
uv.Graph.prototype.setLegend = function (legendHandler) {
  var self = this;
...
uv.LineGraph.prototype.drawHorizontalLines = function (linegroup, idx) {
  ...
  linegroup.path.append('path')
        ...
        .transition()
          ...
          .call(uv.util.endAll, function (d,i){
            d3.select(this.parentNode.parentNode).selectAll('path').on('mouseover', self.config.effects.lineMouseOver ? self.config.effects.lineMouseOver(self, idx) : uv.effects.line.mouseover(self, idx));
            d3.select(this.parentNode.parentNode).selectAll('path').on('mouseout', self.config.effects.lineMouseOut ? self.config.effects.lineMouseOut(self, idx) : uv.effects.line.mouseout(self, idx));
            d3.select(this.parentNode.parentNode).selectAll('circle').on('mouseover', self.config.effects.lineMouseOver ? self.config.effects.lineMouseOver(self, idx) : uv.effects.line.mouseover(self, idx));
            d3.select(this.parentNode.parentNode).selectAll('circle').on('mouseout', self.config.effects.lineMouseOut ? self.config.effects.lineMouseOut(self, idx) : uv.effects.line.mouseout(self, idx));
          });
